...
public class FontFace {
    ...
    public static final String DIGITAL_LED = "fonts/digital.ttf";
    ...
    public static void setAppFontToLed(Context context) {
        overrideFont(context, MONOSPACE, DIGITAL_LED);
    }

    public static Typeface toDigitalLedFontface(Context context) {
        return Typeface.createFromAsset(context.getAssets(), DIGITAL_LED);
    }
